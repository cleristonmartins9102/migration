...
var make_ds_stub_1 = require("./tests/infra/repository/stub/make-ds-stub");
var dsStub = new make_ds_stub_1.MakeDsStub();
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    var prisma, newMember;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dsStub.build()];
            case 1:
