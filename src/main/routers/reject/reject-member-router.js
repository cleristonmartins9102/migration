...
exports.rejectMemberRouter = void 0;
 ...
 *       bearerFormat: JWT
 */
var rejectMemberRouter = function (router) {
    router.post('/reject', (0, adapters_1.expressAdapter)((0, controller_1.rejectMemberControllerFactory)()));
};
exports.rejectMemberRouter = rejectMemberRouter;
