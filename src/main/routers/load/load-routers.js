 ...
 *       bearerFormat: JWT
 */
var loadRouters = function (router) {
    ...
    router.get('/load', authMiddleware, (0, adapters_1.expressAdapter)((0, controller_1.loadAllMemberControllerFactory)()));
    router.post('/load/internal-id-batch', authMiddleware, (0, adapters_1.expressAdapter)((0, controller_1.loadMembersByInternalIdBatchControllerFactory)()));
    router.get('/wallet/load/balance', authMiddleware, (0, adapters_1.expressAdapter)((0, controller_1.loadUserWalletControllerFactory)()));
    // router.get('/load/internal_id/:id', authMiddleware, expressAdapter(loadMemberByInternalIdControllerFactory()))
    router.get('/load/phone-number/:phone_number', authMiddleware, (0, adapters_1.expressAdapter)((0, controller_1.loadMemberByPhoneNumberControllerFactory)()));
};
