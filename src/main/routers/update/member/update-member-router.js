...
exports.updateMemberRouter = void 0;
 ...
 *       bearerFormat: JWT
 */
var updateMemberRouter = function (router) {
    ...
    router.post('/update', authMiddleware, (0, adapters_1.expressAdapter)((0, controller_1.updateMemberNotificationDecoratorControllerFactory)()));
};
exports.updateMemberRouter = updateMemberRouter;
