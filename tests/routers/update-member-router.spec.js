...
var fakeData = (0, stubs_1.makeFakeMember)();
jest.mock('../../src/infra/repository/pg-member-repository.ts', function () {
    return {
        PgMemberRepository: function () {
            return {
                update: function () { return (0, stubs_1.makeFakeMember)(); },
                loadById: function () { return (0, stubs_1.makeFakeMember)(); },
            };
        }
    };
});
describe('Update member Router', function () {
    it.only('should return 400 if missing id', function () { return __awaiter(void 0, void 0, void 0, function () {
        var httpResponse, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    expect(httpResponse.body.filter(function (error) { return error.parameter === 'id'; }).length > 0).toBeTruthy();
                    return [2 /*return*/];
            }
        });
    }); });
