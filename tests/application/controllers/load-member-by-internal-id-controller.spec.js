...
describe('Load Member By internal_id', function () {
    ...
    var pgMemberRepositoryResponse;
    beforeAll(function () {
        pgMemberRepositoryResponse = (0, stubs_1.makeFakeMember)();
        pgMemberRepository = (0, Mock_1.default)();
        pgMemberRepository.loadByInternalId.mockResolvedValue(pgMemberRepositoryResponse);
        sut = new controller_1.LoadMemberByInternalIdController(pgMemberRepository);
    ...
    describe('PgMemberRepository', function () {
        it('Should call loadByInternalId with correct value', function () { return __awaiter(void 0, void 0, void 0, function () {
